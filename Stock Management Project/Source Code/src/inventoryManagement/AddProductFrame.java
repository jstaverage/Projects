...
//Date 		   : March 2022
//Purpose 	   : Add product frame for adding products to the database
...
/**
 * Add Product GUI Frame for adding Inventory items to database
...
public class AddProductFrame extends JFrame {
    ...
    ArrayList<Object> suppID = new ArrayList<>();
    ArrayList<Object> suppName = new ArrayList<>();
    //Reference to parent
     ...
     */
    public AddProductFrame(InventoryFrame parent)
    {	
    	//Call method to build frame
        buildFrame();
        //Set instance varibles
        this.parent = parent;
    ...
    {    	
	    ...
	    panelTop.setLayout(new BoxLayout(panelTop,BoxLayout.LINE_AXIS));
	        ...
	        labelText.setText("VENTAIR - ADD PRODUCT");
	    //Add components
        ...
        panelButtons.setMaximumSize(new Dimension(755,30));
        	...
        	//Add Button
	        btnAdd = new JButton();
	        btnAdd.setBackground(new Color(166, 76, 156));
	        ...
	        btnAdd.setMaximumSize(new Dimension(120, 30));
				...
				new ActionListener() 
				{
		            ...
		            public void actionPerformed(ActionEvent evt) 
		            {
		                ...
		                {   //Will check components on panel, if Component is a Jpanel inner for loop will check for JTextfields and validate them
		                    ...
		                    System.out.println("Here" + tAreaDesc.getText());
		                    ...
		                    else
		                    {
		                        int confirm = 0;
		                        //Ask user to confirm
		                        confirm = JOptionPane.showConfirmDialog(null, "Are you sure you wish to add product?");
		                        if(confirm == 0)
		                        {   
		                            ...
		                            int test = inv.createInvEntry();
		                            if(test == 1)
		                            {
		                                JOptionPane.showMessageDialog(frame, "Product successfully added");
		                                //Call refresh table for Inventory Frame
	        ...
	        btnClear.addActionListener(
					...
					new ActionListener() 
					{
			            ...
			            public void actionPerformed(ActionEvent evt) 
			            {
			                ...
			                tFldProductName.setText("");
			                tAreaDesc.setText("");
			                tFldCostPrice.setText("");
			                tFldRetailPrice.setText("");
			                tFldQtyinStock.setText("");
			                tFldMaxStock.setText("");
			                comboSuppId.setSelectedIndex(0);
			                tFldReorderLevel.setText("");
			                tFldQtyOrder.setText("");
			             }
					}
					);//End Action Listener
	        btnExit = new JButton();
     ...
     */
    //Method to fill supplier combobox from database
    ...
    {   
        ...
        {
            JOptionPane.showMessageDialog(this, "Supplier retrieval from database failed, please contact your administrator");
        }
        finally
        {
