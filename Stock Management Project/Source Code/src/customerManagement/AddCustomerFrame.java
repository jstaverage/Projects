...
//Date 		   : March 2022
//Purpose 	   : Add Customer frame class to add Customer records
...
//CLass for Add Cutomer Frame which allows user to add Customer Records

/**
 * Add Customer GUI Frame for adding Customers to database
...
public class AddCustomerFrame extends JFrame {
    ...
    {    	
	    ...
	    panelTop.setLayout(new BoxLayout(panelTop,BoxLayout.LINE_AXIS));
	        ...
	        labelText.setText("VENTAIR - ADD CUSTOMER");
	    //Add components
        ...
        panelButtons.setMaximumSize(new Dimension(755,30));
	        ...
	        btnAdd.setMaximumSize(new Dimension(140, 30));
	        btnAdd.addActionListener(
				...
				new ActionListener() 
				{
		            ...
		            public void actionPerformed(ActionEvent evt) 
		            {
		            	// Add Customer Button Press Event
		                //Validate data
		                ...
		                {   //Will check components on panel, if Component is a Jpanel inner for loop will check for JTextfields and validate them
		                    ...
		                    int confirm = 0;
		                    confirm = JOptionPane.showConfirmDialog(null, "Are you sure you wish to add customer?");
		                    if(confirm == 0)
		                    {   
		                        ...
		                        {
		                            JOptionPane.showMessageDialog(frame, "Problem adding customer, please try again");
		                        }
	        ...
	        btnClear.setPreferredSize(new Dimension(140, 30));
	        btnClear.setMaximumSize(new Dimension(140, 30));
	    ...
	    //Add Buttons
		panelButtons.add(Box.createRigidArea(new Dimension(335,0)));
