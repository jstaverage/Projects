...
//Date 	            : March 2022
//Purpose 	    : Customer View Sales Order Frame to allow customer to view the details of Sales Orders, only staff can edit or delete these orders
 ...
 */
public class CustViewOrdFrame extends JFrame 
{
	//Declare components
    ...
    //Create reference for JFrame window
   	CustViewOrdFrame frame = this;
      
    //Instance variable for input parameter orderID
    private int orderID;
    
    /**
     * Constructor for Customer View Sales Order Frame
     * @param orderID - Takes an integer as a parameter to hold the order ID
     */
    public CustViewOrdFrame(int orderID)	
    {
        //Call method to build GUI frame
    	buildFrame();
    	//Set instance variable to input order ID
    ...
    private void buildFrame() 
    {
        ...
        panelSideMenu.setPreferredSize(new Dimension(150,60));
     ...
     */
    //Method to retrieve Customer details to fill textfields, returns the Customer VATNo
    ...
    {  
        //Format objects to format currency doubles
        ...
        {   //Create table model and set row count to 0 to clear table before filling
            ...
            //Create ArrayList to hold orderItems
            ArrayList<OrderItem> items = new ArrayList<>();
            
            //Create and execute query to return Sales Order details
            ...
            //Set total fields values formatted to currency
